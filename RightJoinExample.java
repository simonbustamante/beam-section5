...
//right join is similar to left join. this join returns all the rows from the right sidetable and 
...
public class RightJoinExample {
	...
	public static void main(String[] args) {
		...
		output.apply(TextIO.write().to("/home/sabb/Documents/Beam/Section5/right_join_example.csv").withNumShards(1).withSuffix(".csv"));		
		 p.run();   
